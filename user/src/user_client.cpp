...
void Client::CommandsHandler(const UserConnectResponse *resp) {
  switch (resp->command()) {
    case USER_COMMAND_NONE:
...
void Client::handleCommandNone(const UserConnectResponse *response) {}
...
void Client::handleCommandUnrecognized(const UserConnectResponse *response) {
